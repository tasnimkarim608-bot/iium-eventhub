        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user() && Auth::user()->role == 'organiser' ? route('organizer.dashboard') : route('events') }}" class="flex items-center gap-2">
                        <img src="/images/Logo.png" alt="Logo" style="height: 35px; width: auto;">
                        <img src="/images/Textlogo.png" alt="IIUM Hub" style="height: 30px; width: auto;">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(Auth::user() && Auth::user()->role == 'organiser')
